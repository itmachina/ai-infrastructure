...
public class AIInfrastructureIntegrationTest {
    ...
    private static void testAgentFunctionality() {
        ...
        try {
            MainAgent mainAgent = new MainAgent("test-main-2", "Test Main Agent 2", System.getenv("AI_API_KEY"));
    ...
    private static void testFullApplicationFlow() {
        ...
        try {
            ...
            // 执行一系列任务
            application.executeTask("Calculate the sum of 1 to 100");
            application.executeTask("Read the system configuration file");
            application.executeTask("Search for Java documentation");
